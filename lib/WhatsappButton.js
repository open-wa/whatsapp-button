...
class WhatsappButton extends Button {
    constructor() {
        ...
        console.log("WhatsappButton -> constructor -> this.icon", this.icon.type);
        ...
        this.onclick = () => {
            ...
            window.open(`https://api.whatsapp.com/send?phone=${this.dialcode}${this.phone}&text=${encodeURIComponent(this.text)}`);
        };
    }
    static get styles() {
        return [
